...
健康档案、家属授权、服务目录、履约、求助投递、短信和微信认证等业务尚未实现。所有预留页面明确展示待开发状态；老人档案管理位于管理后台 `/elders`。移动端底部导航为首页、服务、健康、我的。

当前范围已移除支付退款与对账、预约容量与派单、投诉回访与统计、独立审计与隐私申请模块；保留老人档案自身的变更记录及访问保护。
